...
public class AppliTestDAL {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //Test Select by Marque
            List<Article> selectMarque = articleDAO.selectByMarque(a2.getMarque());
            System.out.println("\nSélection de l'article par marque  : " + a2.getMarque());
            afficherArticles(selectMarque);

            //Test Select by Marque
            String testMotCle = "A4";
            List<Article> selectMotCle = articleDAO.selectByMotCle(testMotCle);
            System.out.println("\nSélection de l'article par mot clé  : " + testMotCle);
            afficherArticles(selectMotCle);
